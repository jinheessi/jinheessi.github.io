...
const Emergency = () => {
    const change=(index) =>{
        ...
        var sel = document.querySelector("#county2");
        /* 옵션메뉴삭제 */
                ...
                <Frame>
                    <div className="row">
                        <div className="col-md-5 col-12">
                            <p style={{ fontSize: '20pt', color: 'black' }}><b>내 주변 응급실</b></p>
                        </div>
                        <div className="col-md-7 col-12">
                            <form id="form2" name="form2" method="post" onSubmit="geocoder.addressSearch(this.value)">
                            <div className="row">
                                <div className="col-4 d-flex align-items-end">
                                <select id="city2" name="city2"  onChange = {(e) => change(e.target.selectedIndex)} className="form-select d-flex align-items-end" style={{ color: 'gray' }}>
                                ...
                                <div className="col-4 d-flex align-items-end">
                                <select id="county2" name="county2"  className="form-select d-flex align-items-end" style={{ color: 'gray' }}>
                            ...
                            <div id="menu_wrap_2">
                                ...
                                <div className="card"  style={{ border: 'none' }}> 
                                    ...
                                    <table className="table">
                                        ...
                                        <tbody id="hospital_table_2" className="table-border-bottom-0">
