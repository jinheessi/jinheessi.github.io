        ...
        <div>
            ...
            <div className="row">
	              <div className="col-md-5 col-12">
	              	<p style={{fontSize:'22pt', color:'black', fontWeight:'bold'}}><b>아기 수첩 수정</b></p>
          	      </div>
