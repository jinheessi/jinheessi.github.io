                        ...
                        <Frame>
                            <div className="row">
                                <div className="col-md-5 col-12">
                                    <p style={{ fontSize: '20pt', color: 'black' }}><b>내 주변 소아과</b></p>
                                </div>
                                    <div className="col-md-7 col-12">
                                        <form id="form1" name="form1" method="post" onSubmit="geocoder.addressSearch(this.value)">
                                        <div className="row">
                                            <div className="col-4 d-flex align-items-end">
                                            <select id="city1" name="city1"  onChange = {(e) => change(e.target.selectedIndex)} className="form-select d-flex align-items-end" style={{ color: 'gray' }}>
                                            ...
                                            <div className="col-4 d-flex align-items-end">
                                            <select id="county1" name="county1"  className="form-select d-flex align-items-end" style={{ color: 'gray' }}>
                                            ...
                                            <div className="option">
                                                ...
                                                <div className="card"  style={{ border: 'none' }}>
                                                    ...
                                                    <table className="table">
                                                        ...
                                                        <tbody id="hospital_table_1" className="table-border-bottom-0">
